...
@Component({
  selector: 'app-new-dispositif-medical',
  templateUrl: './new-dispositif-medical.component.html',
  styleUrls: ['./new-dispositif-medical.component.scss']
})
export class NewDispositifMedicalComponent implements OnInit,OnChanges {
  bilanForm: FormGroup;
...
ngOnChanges(changes: SimpleChanges): void {
  ...
  onSubmit(): void {
    ...
    this.clientGttp.post('dispositif-medical/save',newBilan).subscribe(
